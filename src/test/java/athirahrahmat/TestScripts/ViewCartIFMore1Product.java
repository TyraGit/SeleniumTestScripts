...
public class ViewCartIFMore1Product extends BaseTest {
    ...
    public void verifyProdInCart() {
        ...
        try {
            ...
            // Open Cart page
            WebElement cartButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".btn.btn-custom[routerlink='/dashboard/cart']")));
            cartButton.click();
